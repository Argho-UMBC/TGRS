...
def make_vocab_questions(input_dir):
    ...
    with open('C:\\Users\\asarkar2\\Bina_Lab\\Harvey_VQA\\torch\\vocab_questions.txt', 'w') as f:
        f.writelines([w+'\n' for w in vocab_list])
...
def make_vocab_answers(input_dir, n_answers):
    ...
    for dataset in datasets:
        ...
        for annotation in annotations:
            word = str(annotation['Ground_Truth'])
...
#                     continue
    ...
    with open('C:\\Users\\asarkar2\\Bina_Lab\\Harvey_VQA\\torch\\vocab_answers.txt', 'w') as f:
...
def main(args):
    ...
    make_vocab_answers(input_dir+'questions\\', n_answers)
