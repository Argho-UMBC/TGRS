...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default="C:\\Users\\asarkar2\\argho\\XBD_Data\\basic_vqa\\images",
                        help='directory for input images (unresized images)')

    parser.add_argument('--output_dir', type=str, default='C:\\Users\\asarkar2\\argho\\XBD_Data\\basic_vqa\\reshape_images',
